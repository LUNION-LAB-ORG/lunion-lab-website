...
export default function FAQSection() {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "La plupart des demandes de conception sont complétées en 1 à 3 jours ouvrables, en fonction de la complexité. Les demandes simples, comme les graphismes pour les réseaux sociaux, peuvent être terminées en 24 heures, tandis que les projets plus complexes peuvent prendre plus de temps.",
    },
    {
      id: 4,
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-[#704a9b] to-black">
          ...
          {faqItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3 className="text-lg lg:text-xl  text-white font-medium pr-8 group-hover:text-white transition-colors bg-clip-text text-transparent bg-gradient-to-r from-[#704a9b] to-black">
                    {item.question}
                  </h3>
