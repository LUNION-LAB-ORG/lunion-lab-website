  ...
  const packages = [
    {
      ...
      currency: "XOF",
      period: "/mois",
      description: "Pour les petites entreprises et les startups qui développent leur présence en ligne.",
      features: [
    ...
    },
    {
      ...
      currency: "XOF",
      period: "/mois",
      description: "Pour les entreprises en croissance qui ont besoin d'un délai d'exécution rapide.",
      features: [
    ...
    },
    {
      ...
      currency: "XOF",
      period: "/mois",
      description: "Vous recherchez un autre domaine d'intervention ? Nous proposons également des solutions sur mesure.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <h2 className="text-4xl lg:text-4xl xl:text-5xl font-bold text-white mb-6">
           <HomeTitle text='Choisissez nos packages' imageSrc={'/assets/images/vectors/vector1.svg'} />
          </h2>
          <p className="text-lg lg:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed">
            Explorez nos packages sur mesure pour répondre à vos besoins spécifiques. Trouvez la 
            solution parfaite pour propulser votre entreprise vers de nouveaux sommets.
          </p>
        </div>
