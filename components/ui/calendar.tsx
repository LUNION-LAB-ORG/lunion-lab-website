...
function Calendar({
  ...
  const defaultClassNames = {
    months: "relative flex flex-col text-white  sm:flex-row gap-4",
    month: "w-full",
    month_caption:
      "relative mx-10 text-white  mb-1 flex h-9 items-center justify-center z-20",
    caption_label: "text-sm text-white  font-medium text-white ",
